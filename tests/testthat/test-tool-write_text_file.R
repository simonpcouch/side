...
test_that("handle_insert creates and modifies content correctly", {
  ...
  expect_equal(
    result_middle$new_content,
    c("line 1", "inserted", "line 2", "line 3")
  )
  ...
  result_beginning <- handle_insert(
    content_beginning,
    insert_line = 0,
    new_str = "new first",
    path = "test.R"
  ...
  result_multiline <- handle_insert(
    content_multiline,
    insert_line = 1,
    new_str = "new line 1\nnew line 2",
    path = "test.R"
  ...
  expect_equal(
    result_multiline$new_content,
    c("line 1", "new line 1", "new line 2", "line 2")
  )
...
test_that("handle_str_replace replaces single and multiline text", {
  ...
  result_single <- handle_str_replace(
    content_single,
    old_str = "old text",
    new_str = "new text",
    path = "test.R"
  ...
  expect_equal(
    result_multiline$new_content,
    c("line 1", "new line 1", "new line 2", "line 4")
  )
